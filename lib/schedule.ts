  ...
  try {
    let query = supabase.from("schedule").select(`
        ...
        team_a:team!schedule_team_a_fkey (
          defender_1:users!team_defender_1_fkey (first_name, last_name, user_id),
          defender_2:users!team_defender_2_fkey (first_name, last_name, user_id),
          defender_3:users!team_defender_3_fkey (first_name, last_name, user_id),
          defender_4:users!team_defender_4_fkey (first_name, last_name, user_id),
          mid_fielder_1:users!team_mid_fielder_1_fkey (first_name, last_name, user_id),
          mid_fielder_2:users!team_mid_fielder_2_fkey (first_name, last_name, user_id),
          mid_fielder_3:users!team_mid_fielder_3_fkey (first_name, last_name, user_id),
          striker_1:users!team_striker_1_fkey (first_name, last_name, user_id),
          striker_2:users!team_striker_2_fkey (first_name, last_name, user_id),
          defender_1_price,
          defender_2_price,
          defender_3_price,
          defender_4_price,
